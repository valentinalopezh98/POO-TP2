...
public class Main {
    public static void main(String[] args) {
        ...
        estacionServicio.agregarVenta(10, "AAA111", 1,"1111");
        estacionServicio.agregarVenta(10, "AAA111", 2,"1111");
        estacionServicio.agregarVenta(10, "AAA111", 2, "1111");
        estacionServicio.agregarVenta(10, "BBB222", 3,"1111");
        estacionServicio.agregarVenta(10, "BBB222", 1,"2222");
        estacionServicio.agregarVenta(10, "CCC333", 2,"2222");
        estacionServicio.agregarVenta(10, "CCC333", 3,"2222");
        estacionServicio.agregarVenta(10, "CCC333", 3,"2222");
        estacionServicio.agregarVenta(10, "DDD444", 3,"2222");
        estacionServicio.agregarVenta(10, "DDD444", 2,"2222");
        estacionServicio.agregarVenta(10, "DDD444", 2,"2222");
        estacionServicio.agregarVenta(10, "DDD444", 2,"2222");
        estacionServicio.agregarVenta(10, "EEE555", 3,"2222");
        estacionServicio.agregarVenta(10, "EEE555", 1,"2222");
        estacionServicio.agregarVenta(10, "FFF666", 1,"3333");
        estacionServicio.agregarVenta(10, "GGG777", 2,"3333");
        estacionServicio.agregarVenta(10, "GGG777", 2,"3333");
        estacionServicio.agregarVenta(10, "HHH888", 1,"3333");
        estacionServicio.agregarVenta(10, "HHH888", 3,"3333");
        estacionServicio.agregarVenta(10, "III999", 1,"3333");
        estacionServicio.agregarVenta(10, "III999", 3,"3333");
        estacionServicio.agregarVenta(10, "JJJ000", 1,"3333");
        estacionServicio.agregarVentaConDescuento(10, "KKK111", 3,"3333");
